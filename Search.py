...
if filtered.empty:
    ...
    st.dataframe(
        ...
        "SN": st.column_config.TextColumn("SN"),
        "ได้รับมาจาก": st.column_config.TextColumn("ได้รับมาจาก"),
        "Status": st.column_config.TextColumn("Status"),
        "Location": st.column_config.TextColumn("Location"),
        "Case Ticket": st.column_config.TextColumn("Case Ticket"),
        "Faulty": st.column_config.TextColumn("Faulty"),
